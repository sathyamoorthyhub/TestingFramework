...
/* @DataProvider(name="Fruitnames")
 ...
 return Datareading.getExcelData("Fruitlist",1);
...
@Test(priority=2,description="Navigate to next page",groups= {"Smoke testing","Functional testing","Regression testing"})
